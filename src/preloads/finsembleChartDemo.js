/**
 * Finsmeble integration with ChartIQ charts - linker, drag drop etc
 * @param {*} stx
 */
const injectFinsmebleInteraction = (stx) => {
	// #region Emitters
	const symbolEmitter = () => {
...
const FSBLReady = () => {
	try {
		console.log("CHART injecton loaded")

		// Do things with FSBL in here.
		injectFinsmebleInteraction(window.stxx)
	} catch (e) {
		FSBL.Clients.Logger.error(e);
	}
}
