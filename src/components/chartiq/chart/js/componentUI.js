...
(function (definition) {
	...
	if (typeof exports === "object" && typeof module === "object") {
		module.exports = definition(require('chartiq'),require('thirdparty/object-observe'), require('thirdparty/@webcomponents/custom-elements.min'));
	...
	(function(){
		...
		var raf = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame ||
			function(fn){ return setTimeout(fn, 20); };
	...
	CIQ.UI.makeFromTemplate=function(node, appendTo){
		...
		function copyNodes(n){
			return function() { n.appendChild(this.cloneNode(true)); };
		}
	...
	class ContextTag extends BaseComponent {
		 ...
		 */
		setContext(context){ /* override me */	}
	...
	CIQ.UI.HeadsUp.prototype.position=function(){
		...
		function formatPrice(value){
			var numStr="";
			var chartScale=stx.layout.chartScale, panel=stx.chart.panel, yAxis=stx.chart.yAxis;
