...
(function (definition) {
	...
	CIQ.QuoteFeed.Xignite.Templates={
		...
		HistoricalEquity: {
			...
			fields:	"Message,HistoricalQuotes.Date,HistoricalQuotes.Close,HistoricalQuotes.Open,HistoricalQuotes.High,HistoricalQuotes.Low,HistoricalQuotes.Volume,HistoricalQuotes.CumulativeAdjustmentFactor",
			results:{
				message:"Message",
