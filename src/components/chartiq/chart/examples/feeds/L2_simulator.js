...
(function (definition) {
	...
	CIQ.simulateL2=function(params){
		...
		function moveBidAsk(close){
			...
			var data={
				BidL2: {
					price: [-0.074, -0.073,
									...
									-0.030, -0.029, -0.028, -0.027, -0.026, -0.025, -0.024, -0.022, -0.021,
				...
				AskL2: {
					price: [0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.007, 0.008, 0.009,
			 			 			0.010, 0.011, 0.012, 0.013, 0.014, 0.015, 0.016, 0.018, 0.019,
			 			 			0.020, 0.021, 0.022, 0.023, 0.024, 0.025, 0.026, 0.027, 0.028, 0.029,
			 			 			0.033, 0.034, 0.035, 0.036, 0.037, 0.038, 0.039,
			 			 			0.040, 0.041, 0.042, 0.044, 0.046, 0.047,
			 			 			0.051, 0.058,
						 			0.060, 0.063,
						 			0.077],
			...
			var shadowBreaks=[[1000,2],[10,4],[0.001,8]];
