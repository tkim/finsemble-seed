...
function runBusinessLogic(cb){
    ...
    // var cookie = getCookie("MSISAuth");
    // console.log("MARK's COOKIE: ", cookie);
    // debugger;
    cb();
}
...
function completeAuth(){
    try{
        runBusinessLogic(function(){
            // Finish the authentication process and close the window
            console.log("Mark ABOUT TO PUBLISH PAUSE");
            // debugger;
            var username =  "mark";
