...
Finsemble.Clients.Logger.log("notificationsUI Service starting up");
 ...
 */
class notificationsUIService extends Finsemble.baseService {
	/**
	 * Initializes a new instance of the notificationsUIService class.
	 */
	constructor() {
		super({
	...
	readyHandler(callback) {
		...
		Finsemble.Clients.Logger.log("notificationsUI Service ready");
		callback();
	}
...
const serviceInstance = new notificationsUIService();
